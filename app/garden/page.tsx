...
export default function GardenPage() {
    ...
    const [showPhrasesHub, setShowPhrasesHub] = useState(false);
        ...
        <GardenLayout>
            <header className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
                <div className="text-center md:text-left">
                    ...
                    <p className="text-pink-800/60 font-medium mt-2 tracking-wide">Cultivando belas memórias</p>
                </div>
                ...
                <div className="flex flex-wrap justify-center items-center gap-4">
                    ...
                    <button
                        onClick={() => setShowPhrasesHub(true)}
            ...
            <input type="file" ref={phrasesInputRef} onChange={handlePhrasesUpload} accept="application/json" className="hidden" />
            ...
            {showPhrasesHub && (
                <PhrasesManagerModal
                    ...
                    onImport={handlePhrasesUpload}
                    onClose={() => setShowPhrasesHub(false)}
